...
*** Designing Physics
The finest VR programs are built in collaboration between 3D designers and 3D developers. The possibilities of VR allow the design team to dream and create, yet they must consider the more complex their designs the more resources needed during integration with the development team. 
